...
Map<String, Map<String, String>> strings = {
  "en": {
    ...
    "error.ADMIN_ALREADY_ADDED":
        "This number is already registered as an admin on Asia Bazar",
    ...
    "addUser.note": "Note:",
    "addUser.note.admin":
        "The admin will be able to receive orders, update their status and view inventory",
    "addUser.note.super_admin":
        "The super admin will have admin privileges plus add and manage other admins/super admins and manage inventory",
    "addUser.add": "Add",
    ...
    "home.noOrders": "No orders have been placed yet",
    ...
    "updateInfo.contactInfo": "Contact info",
    "updateInfo.error.includePlus": "Please start the phone number with +",
    "updateInfo.result.success": "Info successfully updated",
    "updateInfo.result.error": "Some error in updating the info",
    "updateInfo.update": "Update",
    "updateInfo.inDollars":"(in \$)",
    "updateInfo.invalid": "One or more fields have invalid values",
    "updateInfo.error.invalidValue": "Please enter a valid value",
    "updateInfo.pointsInfo": "Loyalty points info",
    "updateInfo.points.minPointsToUse": "Minimum points",
    "updateInfo.points.minPointsToUse.info":
        "These are the minimum loyalty points a user must have in his account to use them while checking out.",
    "updateInfo.points.pointsValue": "Points value",
    "updateInfo.points.pointsValue.info": "The value of a loyalty point in \$.",
    "updateInfo.chargeInfo": "Charges info",
    "updateInfo.contactNumber": "Contact number",
    "updateInfo.heading": "Update seller info",
